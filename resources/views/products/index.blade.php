    ...
    <div class="modal fade" id="productModal" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="productForm" enctype="multipart/form-data">
                <div class="mb-3 row">
                <label for="productName" class="col-sm-4 col-form-label">  Product Name <span class='text-danger'>*</span></label>
                <div class="col-sm-8">
                ...
                <div class="mb-3 row">
                <label for="productPrice" class="col-sm-4 col-form-label"> Price <span class='text-danger'>*</span></label>
                <div class="col-sm-8">
                ...
                <div class="mb-3 row">
                <label for="productImages" class="col-sm-4 col-form-label">Images <span class='text-danger'>*</span></label>
                <div class="col-sm-8">
